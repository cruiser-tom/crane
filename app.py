...
* **Your Task:** Use the AI assistant to detect coordinated bot attacks in a simulated product catalog.
* **Data Privacy:** Your completion time and interaction metrics will be recorded completely anonymously.

Please click the button below to be assigned to your system interface and begin the task.
""")
